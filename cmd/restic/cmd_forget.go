...
func init() {
	...
	f.VarP(&forgetOptions.MaxHourly, "max-hourly", "", "Only hourly snapshots younger than `duration` will be saved.")
	f.VarP(&forgetOptions.MaxDaily, "max-daily", "", "Only daily snapshots younger than `duration` will be saved.")
	f.VarP(&forgetOptions.MaxWeekly, "max-weekly", "", "Only weekly snapshots younger than `duration` will be saved.")
	f.VarP(&forgetOptions.MaxMonthly, "max-monthly", "", "Only monthly snapshots younger than `duration` will be saved.")
	f.VarP(&forgetOptions.MaxYearly, "max-yearly", "", "Only yearly snapshots younger than `duration` will be saved.")
